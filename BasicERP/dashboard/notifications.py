...
def email_order_groups(order: Order) -> None:
    """emails all members in the orders groups"""
    subject = "New Order in Domain"
    message = render_to_string("dashboard/email/new_order.html", {"order": order})
